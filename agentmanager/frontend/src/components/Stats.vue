<template>
  <div class="bg-white py-14 8sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl lg:max-w-none">
        <div class="text-center">
          <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Admin Dashboard Inpectit Gepard</h2>
...
<script setup>
const stats = [
  { id: 1, name: 'Angemeldete Agenten', value: '8,000+' },
  { id: 2, name: 'Redirection Rate ', value: '3%' },
  { id: 3, name: 'Uptime guarantee', value: '99.9%' },
  { id: 4, name: 'other', value: '42' },
]
</script>